...
function fetchQuote() {
  // You can replace this with your own API call to get a quote
  const quotes = [
  ...
  // Update the quote element with the fetched quote
...
function initialize() {
  ...
  // Add event listener to the button to fetch another quote
  document.getElementById('getbtn').addEventListener('click', fetchQuote);
}
